...
*And understanding that might be the most important thing you do this year as a blockchain developer.*
...
*This is part of an ongoing series documenting my progress through the CKBuilders program. The next piece will cover xUDT token construction, the Spore Protocol in code, and what it actually takes to write and deploy a custom lock script in Rust.*
